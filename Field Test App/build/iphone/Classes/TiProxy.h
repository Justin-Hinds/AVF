...
//Rare exceptions to indicate a bug in the _fieldtestapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for FieldTestApp proxies.
 */
