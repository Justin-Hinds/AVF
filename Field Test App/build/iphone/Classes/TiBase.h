...
// in simulator we redefine to format for FieldTestApp Developer console
...
{\
	NSString * exceptionName = [@"org.fieldtestapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.fieldtestapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIFieldTestAppNativeItemNone = -1, 
	UIFieldTestAppNativeItemSpinner = -2,
	UIFieldTestAppNativeItemProgressBar = -3,
	
	UIFieldTestAppNativeItemSlider = -4,
	UIFieldTestAppNativeItemSwitch = -5,
	UIFieldTestAppNativeItemMultiButton = -6,
	UIFieldTestAppNativeItemSegmented = -7,
	
	UIFieldTestAppNativeItemTextView = -8,
	UIFieldTestAppNativeItemTextField = -9,
	UIFieldTestAppNativeItemSearchBar = -10,
	
	UIFieldTestAppNativeItemPicker = -11,
	UIFieldTestAppNativeItemDatePicker = -12,
	
	UIFieldTestAppNativeItemInfoLight = -13,
	UIFieldTestAppNativeItemInfoDark = -14,
	
	UIFieldTestAppNativeItemDisclosure = -15,
	
	UIFieldTestAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all FieldTestApp instances of
