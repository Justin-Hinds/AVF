...
//@interface FieldTestAppObject : NSObject
//@end

@interface FieldTestAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[FieldTestAppObject class]])
		{
			for (NSString *key in [[(FieldTestAppObject*)o modules] allKeys])
			{
