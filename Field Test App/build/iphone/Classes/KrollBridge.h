...
@interface FieldTestAppObject : KrollCoverageObject {
#else
@interface FieldTestAppObject : KrollObject {
#endif
@private
...
extern NSString * FieldTestApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	FieldTestAppObject *_fieldtestapp;
    KrollObject* console;
	BOOL shutdown;
