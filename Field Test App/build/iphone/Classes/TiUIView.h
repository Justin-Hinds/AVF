...
/**
 Base class for all FieldTestApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the FieldTestApp view hierarchy (such as wrapped iOS UIViews) was touched.
