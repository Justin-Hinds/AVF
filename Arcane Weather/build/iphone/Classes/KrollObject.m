...
//@interface ArcaneWeatherObject : NSObject
//@end

@interface ArcaneWeatherObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ArcaneWeatherObject class]])
		{
			for (NSString *key in [[(ArcaneWeatherObject*)o modules] allKeys])
			{
