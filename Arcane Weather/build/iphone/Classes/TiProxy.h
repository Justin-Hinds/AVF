...
//Rare exceptions to indicate a bug in the _arcaneweather code (Eg, function that a subclass should have implemented)
...
/**
 The base class for ArcaneWeather proxies.
 */
