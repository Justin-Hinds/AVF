...
@interface ArcaneWeatherObject : KrollCoverageObject {
#else
@interface ArcaneWeatherObject : KrollObject {
#endif
@private
...
extern NSString * ArcaneWeather$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	ArcaneWeatherObject *_arcaneweather;
    KrollObject* console;
	BOOL shutdown;
