...
/**
 Base class for all ArcaneWeather views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the ArcaneWeather view hierarchy (such as wrapped iOS UIViews) was touched.
