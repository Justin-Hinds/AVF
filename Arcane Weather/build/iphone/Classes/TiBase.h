...
// in simulator we redefine to format for ArcaneWeather Developer console
...
{\
	NSString * exceptionName = [@"org.arcaneweather." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.arcaneweather";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIArcaneWeatherNativeItemNone = -1, 
	UIArcaneWeatherNativeItemSpinner = -2,
	UIArcaneWeatherNativeItemProgressBar = -3,
	
	UIArcaneWeatherNativeItemSlider = -4,
	UIArcaneWeatherNativeItemSwitch = -5,
	UIArcaneWeatherNativeItemMultiButton = -6,
	UIArcaneWeatherNativeItemSegmented = -7,
	
	UIArcaneWeatherNativeItemTextView = -8,
	UIArcaneWeatherNativeItemTextField = -9,
	UIArcaneWeatherNativeItemSearchBar = -10,
	
	UIArcaneWeatherNativeItemPicker = -11,
	UIArcaneWeatherNativeItemDatePicker = -12,
	
	UIArcaneWeatherNativeItemInfoLight = -13,
	UIArcaneWeatherNativeItemInfoDark = -14,
	
	UIArcaneWeatherNativeItemDisclosure = -15,
	
	UIArcaneWeatherNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ArcaneWeather instances of
